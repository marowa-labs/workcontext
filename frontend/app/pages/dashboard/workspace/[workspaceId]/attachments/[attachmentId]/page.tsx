  ...
  return (
    <div className="h-screen flex flex-col bg-background">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
              ...
              {isAILoading && (
                <div className="flex gap-2 justify-start">
                  <div className="bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg px-3 py-2">
                ...
                <div className="space-y-1.5">
                  {suggestedQuestions.slice(0, 5).map((question, idx) => (
                    <button
                      ...
                      className="w-full text-left text-xs text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 p-2 rounded transition-colors disabled:opacity-50 disabled:cursor-wait"
                    >
                      {question}
                    </button>
                  ))}
            ...
            <div className="p-3 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
              <div className="flex gap-2 items-end">
                <textarea
                  ...
                  rows={1}
                  className="flex-1 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none overflow-y-auto dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                  style={{ minHeight: "40px", maxHeight: "150px" }}
                />
                <button
                  onClick={handleSendAIMessage}
                  disabled={!aiInput.trim() || isAILoading}
                  className="px-3 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:bg-gray-300 dark:disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors flex-shrink-0"
                >
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-6 py-3">
          ...
          <div className="flex gap-2 overflow-x-auto pb-1">
            {annotations.map((ann) => (
              <div
                key={ann.id}
                className="flex-shrink-0 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-2 min-w-[160px]"
              >
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <button
                    ...
                    className="ml-auto p-0.5 text-gray-400 dark:text-gray-500 hover:text-red-500 rounded"
                  >
                    <X className="w-3 h-3" />
                  </button>
                </div>
                {ann.text && (
                  <p className="text-xs text-gray-700 dark:text-gray-300">{ann.text}</p>
                )}
                {!ann.text && (
      ...
      {selectionPopup.visible && selectedText && (
        ...
        >
          <div className="flex items-center gap-1 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-1.5">
            <button
              onClick={handleAskAIFromSelection}
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-purple-700 dark:text-purple-300 bg-purple-50 dark:bg-purple-900/30 hover:bg-purple-100 dark:hover:bg-purple-900/50 rounded-lg transition-colors"
