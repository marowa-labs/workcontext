    ...
    const plans = [
      {
        ...
        features: [
          ...
          "GPT-4o-mini or Gemini 2.0 Flash only",
      ...
      },
      {
        ...
        features: [
          ...
          "50 GPT-4o-mini requests",
          "10 GPT-4o requests (complex assignments)",
          "20 Gemini Flash requests",
          "100GB storage",
        ],
        limits: {
          projects: "unlimited",
      ...
      },
      {
        ...
        features: [
          ...
          "Unlimited GPT-4o-mini requests",
